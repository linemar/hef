 ...
 * @LastEditTime: 2022-01-23 17:53:19
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/benchmarks/ssb50/queries/q31.cpp
 */
...
int main()
{
   ...
   size = load_data_str(str_data1, std::string("/home/sunzw/data/ssb/scale_50_spilt/customer_region.txt"));
   c_region = str_data1.data();
