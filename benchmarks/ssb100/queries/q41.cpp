...
int main()
{
   ...
   size = load_data_str(str_data1, std::string("/home/sunzw/data/ssb/scale_50_spilt/part_mfgr.txt"));
   ...
   c_size = load_data_int(int_data7, std::string("/home/sunzw/data/ssb/scale_50_spilt/customer_key.txt"));
