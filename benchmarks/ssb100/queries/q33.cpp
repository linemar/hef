...
int main()
{
   ...
   size = load_data_str(str_data1, std::string("/home/sunzw/data/ssb/scale_50_spilt/customer_city.txt"));
   ...
   size = load_data_str(str_data2, std::string("/home/sunzw/data/ssb/scale_50_spilt/supplier_city.txt"));
