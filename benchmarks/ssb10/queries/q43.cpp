 ...
 * @LastEditTime: 2022-01-21 16:28:09
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/benchmarks/ssb10/queries/q43.cpp
 */
...
double q43_hi(DataBase *db, uint64_t batch_size)
{
...
double q43_hi_block(DataBase *db, uint64_t batch_size)
{
...
int main()
{
   ...
   runtime = q43_hi(db, 36);
   std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(6) << runtime << std::endl;
   // sleep(5);

   // runtime = q43_hi_block(db, 36);
   // std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(6) << runtime << std::endl;
