 ...
 * @LastEditTime: 2022-01-23 18:09:05
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/benchmarks/ssb10/queries/q33.cpp
 */
...
double q33_hi(DataBase *db, uint64_t batch_size)
{
...
double q33_hi_block(DataBase *db, uint64_t batch_size)
{
...
int main()
{
   ...
   runtime = q33_hi(db, 36);
   std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(6) << runtime << std::endl;
   // sleep(30);

   // runtime = q33_hi_block(db, 36);
   // std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(6) << runtime << std::endl;
