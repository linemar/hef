 ...
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/benchmarks/ssb10/queries/q42.cpp
 */
...
double q42_hi(DataBase *db, uint64_t batch_size)
{
...
double q42_hi_block(DataBase *db, uint64_t batch_size)
{
...
int main()
{
   ...
   runtime = q42_hi(db, 36);
   std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(6) << runtime << std::endl;
   // sleep(30);

   // runtime = q42_hi_block(db, 36);
   // std::cout << std::setiosflags(std::ios::fixed) << std::setprecision(6) << runtime << std::endl;
