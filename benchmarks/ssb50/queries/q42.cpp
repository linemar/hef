 ...
 * @LastEditTime: 2022-01-23 17:20:18
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/benchmarks/ssb50/queries/q42.cpp
 */
...
const int part_hash_tabel_size = 16 * 1024 * 1024;
...
double q42_hi(uint64_t batch_size)
{
   uint64_t *lo_rid = new uint64_t[lo_size];
...
double q42_hi_block(uint64_t batch_size)
{
   uint64_t *lo_rid = new uint64_t[lo_size];
   ...
   //build data hash table
   uint64_t *date_hash_table = new uint64_t[date_hash_tabel_size];
   hash_build_rand(d_result_ids, d_datekey, d_size, date_hash_table, date_hash_tabel_size);
...
int main()
{
   ...
   p_size = load_data_int(int_data2, std::string("/home/sunzw/data/ssb/scale_100/part_key.txt"));
   p_partkey = int_data2.data();
   std::cout << "p_size = " << p_size << std::endl;

   std::vector<std::string> str_data1;
   size = load_data_str(str_data1, std::string("/home/sunzw/data/ssb/scale_100/part_mfgr.txt"));
   p_mfgr = str_data1.data();
   ...
   size = load_data_str(str_data2, std::string("/home/sunzw/data/ssb/scale_100/supplier_region.txt"));
   ...
   size = load_data_int(int_data5, std::string("/home/sunzw/data/ssb/scale_100/lineorder_part.txt"));
   ...
   c_size = load_data_int(int_data9, std::string("/home/sunzw/data/ssb/scale_100/customer_key.txt"));
   c_custkey = int_data9.data();
   std::cout << "c_size = " << c_size << std::endl;

   std::vector<std::string> str_data3;
   size = load_data_str(str_data3, std::string("/home/sunzw/data/ssb/scale_100/customer_region.txt"));
   c_region = str_data3.data();

   std::vector<uint64_t> int_data8;
   size = load_data_int(int_data8, std::string("/home/sunzw/data/ssb/scale_100/lineorder_customer.txt"));
