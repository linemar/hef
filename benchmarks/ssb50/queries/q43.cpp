...
int main()
{
   ...
   size = load_data_str(str_data1, std::string("/home/sunzw/data/ssb/scale_100/part_category.txt"));
   ...
   size = load_data_str(str_data2, std::string("/home/sunzw/data/ssb/scale_100/supplier_nation.txt"));
