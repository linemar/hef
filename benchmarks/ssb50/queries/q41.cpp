 ...
 * @LastEditTime: 2022-01-23 16:56:41
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/benchmarks/ssb50/queries/q41.cpp
 */
...
double q41_hi( uint64_t batch_size)
{
   uint64_t *lo_rid = new uint64_t[lo_size];
...
double q41_hi_block( uint64_t batch_size)
{
   uint64_t *lo_rid = new uint64_t[lo_size];
...
int main()
{
   ...
   c_size = load_data_int(int_data7, std::string("/home/sunzw/data/ssb/scale_100/customer_key.txt"));
   c_custkey = int_data7.data();
