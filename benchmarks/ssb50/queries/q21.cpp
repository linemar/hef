 ...
 * @LastEditTime: 2022-01-22 23:43:49
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/benchmarks/ssb50/queries/q21.cpp
 */
...
const int part_hash_tabel_size = 2 * 1024 * 1024;
...
double q21_hi(uint64_t batch_size)
{
    uint64_t *lo_rid = new uint64_t[lo_size];
...
double q21_hi_block(uint64_t batch_size)
{
