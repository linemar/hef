 ...
 * @LastEditTime: 2022-01-05 16:09:38
 * @Description:   
 * @FilePath: /workspace/ecnu/ecnu/hef/pretest/crc64.cpp
 */
...
int crc64_test(DataBase *db, uint64_t batch_size)
{
...
int main(int argc, char * argv[])
{
    ...
    int runtime = crc64_test(db, batch_size);
