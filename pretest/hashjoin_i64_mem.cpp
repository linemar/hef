 ...
 * @LastEditTime: 2022-01-17 09:42:06
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/pretest/hashjoin_i64_mem.cpp
 */
...
double hashjoin_mem_test(uint64_t batch_size)
{
    const int hash_tabel_size = 128 * 1024 * 1024;
    ...
    hashjoin_i64_mem(order_hash_table, hash_tabel_size, l_rid, l_orderkey, l_size - rest, batch_size, l_result, l_result_size);
...
int main(int argc, char *argv[])
{
    ...
    double runtime = (hashjoin_mem_test(batch_size));
