 ...
 * @LastEditTime: 2022-01-13 15:47:48
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/pretest/hashagg_i64_l1.cpp
 */
...
int hashagg_l1_test(DataBase *db, uint64_t batch_size)
{
    ...
    hashagg_i64_l1(date_hash_table, hash_tabel_size, lo_rid, lo_orderdate, lo_size - rest, batch_size, lo_result, lo_result_size);
    ...
    std::cout << "hybird finished, hash tabel size is " << (unsigned int)(hash_tabel_size) << ", use time " << dr_ms << " ms" << std::endl;
...
int main(int argc, char * argv[])
{
    ...
    int runtime = hashjoin_l1_test(db, batch_size);
