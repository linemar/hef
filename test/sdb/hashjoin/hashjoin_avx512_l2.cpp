 ...
 * @LastEditTime: 2022-01-14 10:44:56
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/test/sdb/hashjoin/hashjoin_avx512_l2.cpp
 */
...
double hashjoin_avx512(DataBase *db)
{
    ...
    std::cout << "lo_size_size = " << lo_size << std::endl;
    ...
    {
        __m512i src = _mm512_loadu_epi64(lo_partkey + i);
        __mmask8 mask = probe_avx512(part_hash_table, hash_tabel_size, src);
