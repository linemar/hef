 ...
 * @LastEditTime: 2022-01-11 23:37:13
 * @Description:   
 * @FilePath: /sunzw/workspace/ecnu/ecnu/hef/test/sdb/hashjoin/hashjoin_avx512_l3.cpp
 */
...
{
    const uint64_t hash_tabel_size = 1 * 1024 * 1024;

    std::vector<uint64_t> lo_vector;
    std::vector<uint64_t> o_vector;

    //get table data
    load_data(lo_vector, std::string("/home/sunzw/data/tpch/scale_1/lineitem_line0.txt"));
    load_data(o_vector, std::string("/home/sunzw/data/tpch/scale_1/orders_line0.txt"));
